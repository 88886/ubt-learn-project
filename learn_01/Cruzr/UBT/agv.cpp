...
Agv::Agv(int id,QString code,QString robot_id,QString state,QString address_ip,int port,QString battery,QString type,float x,float y,QWidget *parent): QFrame(parent)
{
    ...
    this->setStyleSheet("QFrame{background-image: url(:/Icon/images/agv-1.jpg);border:3px solid yellow;};");
}
...
void Agv::setClick(QString state){
    if(state=="闲置中"){
        this->setStyleSheet("QFrame{background-image: url(:/Icon/images/agv-1.jpg);border:3px dashed blue;};");
    }else if(state=="故障中"){
        this->setStyleSheet("QFrame{background-image: url(:/Icon/images/agv-1.jpg);border:3px dashed red;};");
    }else {
        this->setStyleSheet("QFrame{background-image: url(:/Icon/images/agv-1.jpg);border:3px dashed yellow;};");
    }
...
void Agv::setUnClick(QString state){
    if(state=="闲置中"){
        this->setStyleSheet("QFrame{background-image: url(:/Icon/images/agv-1.jpg);border:3px solid blue;};");
    }else if(state=="故障中"){
        this->setStyleSheet("QFrame{background-image: url(:/Icon/images/agv-1.jpg);border:3px solid red;};");
    }else {
        this->setStyleSheet("QFrame{background-image: url(:/Icon/images/agv-1.jpg);border:3px solid yellow;};");
    }
