package com.ubtechinc.cruzr.cruzrapirunner.Socket;
...
import com.ubtechinc.cruzr.cruzrapirunner.MainActivity;
            ...
            while (isRun && !socket.isClosed() && !socket.isInputShutdown()){
                try {
                    if ((rcvLen = is.read(buff)) != -1 ){
                        ...
                        SocketCMDService.context.sendBroadcast(intent);//SocketCMDService
