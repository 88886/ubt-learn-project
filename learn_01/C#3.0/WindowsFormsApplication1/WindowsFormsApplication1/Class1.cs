...
namespace upsAPIs
{
    public class upsWebAPIs
    {
        ...
        string str_ip="mes.ubtrobot.com";
        public upsWebAPIs() { 
        ...
        /// <param name="qresult"></param>
        /// <returns></returns>
        public string updateStationExceptions(string[] stationCode, string[] old_exceptions, string[] new_exceptions)
        {
            ...
            try
            {
                int arrylength = stationCode.Length;
                if (arrylength > 0)
                {
