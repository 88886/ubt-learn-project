...
namespace upsAPIs
{
    public class upsWebAPIs
    {
        ...
        //string str_ip = "192.168.248.129:8000";
       // SshClient client = null;
        ...
        public string getTask(string url)
        {
           // string url = "http://" + str_ip + "/api/material/materialInstoreCommand/" + line_id;
            string result = "false";
            string result2 = "11";
            //string url = "192.168.248.129:800";
        ...
        public static string getJsonByObject(Object obj)
       {
        ...
        public Object getMotorMes(string line_id) {

            //string url = "http://" + str_ip + "/api/planning/get_station_serial_code_auto_motor_02/" + line_id;
            //string url = "http://" + str_ip + "/api/planning/test"; 
            string url = "http://192.168.245.128:8000/api/query_work_sheet/radio";
            string result = "false";
            try
            {
                result = Get(url);
                ResponseMotor2 motor = new ResponseMotor2();
                ResponseMotorMes message = new ResponseMotorMes();
                Object objrd = getObjectByJson(result, message);
                message = (ResponseMotorMes)objrd;
                if (message.success == "true")
                {
                    if (message.data != null)
                    {
                        Object obj = message.data;
                        //Object obj = getObjectByJson(message.data, motor);
                        return obj;
                    }
                    else
                    {
