        ...
        public void connectServer() {
            try
            {
                ...
                else 
                {
                    ...
                    string newFilename = filename+"\\log.txt";
                    System.IO.File.Create(newFilename);
                    wr = new StreamWriter(newFilename, true);
            ...
            catch (Exception erroMsg)
            {
                ...
                wr.WriteLine("连接失败"+erroMsg.Message.ToString());
        ...
        public void Send(String sendMSG)
        {
            try
             ...
             catch(Exception erro) 
             {
                ...
                wr.WriteLine("发送失败：" + sendMSG + "  原因：" + erro.Message.ToString());
             }
        }
         /// <summary>
         /// 接收服务端返回的消息
         ...
         private void tryGetTask() {
             ...
             while(true)
             {
                 if (transEnable && flag)
                 {
                     ...
                     if (strTask != null && !strTask.Equals("false")&&!strTask.Equals("False"))
                     {
                         currentTask = strTask;
         ...
         private void btn_connect_Click(object sender, EventArgs e)
         {
             ...
             if (getTaskTxt.Text.ToString().Trim().Equals("")  && updateTaskTxt.Text.ToString().Trim().Equals(""))
             {
                 MessageBox.Show("获取配送地址或者更新配送地址或者工位不能为空！");
         ...
         private void checkBox1_CheckedChanged(object sender, EventArgs e)
         {
             ...
             if (checkBox1.Checked)
             {
                 ...
                 getTaskTxt.Enabled = false;
                 updateTaskTxt.Enabled = false;
                 workStationTxt.Enabled = false;
             ...
             else 
             {
                 ...
                 getTaskTxt.Enabled = true;
                 updateTaskTxt.Enabled = true;
                 workStationTxt.Enabled = true;
             }
         }
         ...
         private void getTaskTxt_TextChanged(object sender, EventArgs e)
         {
